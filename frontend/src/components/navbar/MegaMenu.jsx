...
export default function MegaMenu({ onNavigate }) {
  return (
    <motion.div
      ...
      animate="show"
      exit="exit"
      className="absolute left-1/2 top-[calc(100%+0.75rem)] w-[min(92vw,860px)] -translate-x-1/2 overflow-hidden rounded-3xl border border-white/10 bg-ink-soft/80 p-8 shadow-[0_30px_80px_-20px_rgba(0,0,0,0.8)] backdrop-blur-2xl"
    >
